...
def test_seniors_assigned_to_important_shifts():
    ...
    work_dates = [
        {"id": 101, "date": "2024-05-01", "is_important_shift": True, "required_people": 1}
    ]
...
def test_historical_shift_sorting_fairness():
...
def test_weekend_constraints_respected():
    """Verify weekend constraints are respected."""
    members = [
        {"id": 1, "name": "Weekday Only", "seniority_level": "Junior", "historical_shifts": 0, "availability": "Weekdays"},
        {"id": 2, "name": "Weekend Only", "seniority_level": "Junior", "historical_shifts": 0, "availability": "Weekends"}
    ]
    work_dates = [
